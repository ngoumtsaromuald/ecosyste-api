...
exports.SwaggerDocUtils = void 0;
exports.setupCompleteAuthDocumentation = setupCompleteAuthDocumentation;
const swagger_1 = require("@nestjs/swagger");
const auth_schemas_1 = require("./auth-schemas");
const auth_examples_1 = require("./auth-examples");
function setupCompleteAuthDocumentation(app) {
...
This API is licensed under the MIT License. See LICENSE file for details.
    `)
        ...
        .setContact('ROMAPI Support Team', 'https://romapi.com/support', 'support@romapi.com')
    ...
    document.components.examples = {
        ...
        RefreshTokenRequest: {
            ...
            value: auth_examples_1.AuthSwaggerExamples.Auth.RefreshTokenRequest
        },
        ForgotPasswordRequest: {
            summary: 'Request password reset',
            description: 'Example request to initiate password reset flow',
            value: auth_examples_1.AuthSwaggerExamples.Auth.ForgotPasswordRequest
        },
        ResetPasswordRequest: {
            summary: 'Reset password',
            description: 'Example request to reset password with token',
            value: auth_examples_1.AuthSwaggerExamples.Auth.ResetPasswordRequest
        },
        AuthSuccessResponse: {
        ...
        CreateApiKeyDevelopmentRequest: {
            ...
            value: auth_examples_1.AuthSwaggerExamples.ApiKeys.CreateDevelopmentRequest
        },
        UpdateApiKeyRequest: {
            summary: 'Update API key',
            description: 'Example request to update API key properties',
            value: auth_examples_1.AuthSwaggerExamples.ApiKeys.UpdateRequest
        },
        ...
        ApiKeyStatsResponse: {
            ...
            value: auth_examples_1.AuthSwaggerExamples.ApiKeys.StatsResponse
        },
        ...
        OAuthLinkRequest: {
            ...
            value: auth_examples_1.AuthSwaggerExamples.OAuth.LinkRequest
        },
        ...
        OAuthAccountsListResponse: {
            ...
            value: auth_examples_1.AuthSwaggerExamples.OAuth.AccountsListResponse
        },
        ...
        ForbiddenErrorResponse: {
            ...
            value: auth_examples_1.AuthSwaggerExamples.Errors.ForbiddenError
        },
        ...
        ConflictErrorResponse: {
            ...
            value: auth_examples_1.AuthSwaggerExamples.Errors.ConflictError
        },
        NotFoundErrorResponse: {
            summary: 'Not found error',
            description: 'Example response when requested resource is not found',
            value: auth_examples_1.AuthSwaggerExamples.Errors.NotFoundError
        }
    };
...
exports.SwaggerDocUtils = {
    addOperationDoc: (operation, summary, description, examples) => {
    ...
    addRateLimitDoc: (operation, limit, window = '1 hour') => {
        operation.description = `${operation.description || ''}\n\n**Rate Limit:** ${limit} requests per ${window}`;
        return operation;
    },
    addPermissionDoc: (operation, permissions) => {
